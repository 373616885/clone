...
public class HttpUtils {
	 ...
	 */
	public static com.whale.common.util.HttpResponse httpPostForm(String url,Map<String,String> params, Map<String,String> headers,String encode){
		com.whale.common.util.HttpResponse response = new com.whale.common.util.HttpResponse();
		if(encode == null){
			encode = "utf-8";
		}
	...
	public static void main(String[] args) {
		HttpUtils.doGet("https://www.baidu.com/",null,null);
	}
